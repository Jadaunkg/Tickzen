...
import hashlib
import os
from article_scorer import ArticleImportanceScorer
...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler('rss_analysis.log', encoding='utf-8'),
...
class RSSNewsCollector:
    ...
    def cleanup_old_articles(self, hours_threshold=24):
        ...
        try:
            ...
            if removed_count > 0:
                logging.info(f"Cleanup: Removed {removed_count} old articles, kept {len(recent_articles)} recent articles")
