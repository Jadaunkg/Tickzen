...
class GeminiArticleGenerator:
    ...
    def _build_prompt(
        ...
        prompt = [
            ...
            "=" * 80,
            "",
            "CRITICAL ANTI-PLAGIARISM REQUIREMENTS:",
            "🚫 NEVER copy sentences directly from the source material",
            "🚫 NEVER use the same sentence structure as the original text",
            "🚫 NEVER rewrite information in similar wording",
            "✅ COMPLETELY REPHRASE all information in your own unique words",
            "✅ RESTRUCTURE sentences with different grammar and flow",
            "✅ EXPLAIN concepts independently without mirroring source phrasing",
            "✅ Use synonyms, different sentence structures, and fresh perspectives",
            "✅ Write as if explaining to a student/job seeker in a conversational yet professional tone",
            "",
            "EXAMPLE OF WHAT NOT TO DO:",
            "❌ Source: 'The BCECEB has announced 1445 openings for Junior Resident positions.'",
            "❌ Bad Rewrite: 'BCECEB announced 1445 vacancies for Junior Resident posts.'",
            "✅ Good Rewrite: 'Bihar's medical recruitment board is hiring 1,445 junior doctors across various specialties.'",
            "",
            "GUIDELINES:",
            "✓ Write naturally - like explaining to a friend, not a robot",
            "✓ Use simple, clear language with YOUR OWN unique sentence structures",
            "✓ Explain what, when, and how in a straightforward way using fresh phrasing",
            "✓ Start IMMEDIATELY with key facts - no conversational greetings",
            "✓ No marketing language or robotic phrases",
            "✓ Use the FACTS from the provided information but REWRITE in completely unique ways",
            "✓ Organize with proper HTML headings and formatting",
            "✓ Keep paragraphs SHORT - 2-4 sentences maximum, then start a new <p> tag",
            "✓ STAY FOCUSED - Write ONLY about THIS specific job/exam, no other opportunities",
            "✓ Include ONLY official government/organization links (apply portal, official website, notification PDF)",
            "✓ Use MAXIMUM 3 official external links only - each link must appear ONLY ONCE",
            "✓ Embed links naturally in the text flow - do NOT create a separate links section",
            "✓ NO links to other job portals, other articles, or similar opportunities",
            "",
            "CRITICAL CONTENT FOCUS RULES:",
            "🚫 DO NOT mention other job opportunities or exams",
            "🚫 DO NOT write: 'Beyond this, you might find...', 'Similarly, check out...', 'Also see...'",
            "🚫 DO NOT reference other posts like 'UPSSSC Draftsman Exam', 'NTA UGC NET Result', etc.",
            "🚫 DO NOT suggest readers check other opportunities or recruitment trends",
            "🚫 DO NOT link to other pages on the website - this article is standalone",
            "✅ Write ONLY about THIS specific job/exam/result announcement",
            "✅ Keep the entire article focused on the single topic at hand",
            "✅ If you need to provide context, relate it back to THIS opportunity only",
            "",
            ...
            "✗ 'Beyond this exam, staying informed about...'",
            "✗ 'For instance, you might find updates on...'",
            "✗ 'Similarly, keeping an eye on results from...'",
            "✗ 'Check out other opportunities like...'",
            "✗ Any mention of other job posts, exams, or results",
            "",
            ...
            "- Break long paragraphs into multiple <p> tags for readability",
            "- Use <ul><li> for bullet point lists",
            "- Use <ol><li> for numbered steps (like application process)",
            "- MANDATORY: Use <table> for ALL DATA - dates, vacancies, fees, age limits, etc.",
            "- Use <table> with proper <thead>, <tbody>, <tr>, <td> structure and inline styles",
            "- Use <a href=\"URL\" target=\"_blank\" rel=\"dofollow\"> for official links ONLY",
            "- DO NOT link to other articles, job posts, or non-official websites",
            "",
            "TABLE REQUIREMENTS - VERY IMPORTANT:",
            "✅ MUST use tables to present structured data like:",
            "  - Important dates (application start/end, exam date, result date)",
            "  - Vacancy details (position name, number of posts, location)",
            "  - Fee structure (category-wise fees)",
            "  - Age limits (minimum, maximum, relaxation by category)",
            "  - Educational qualifications by position",
            "  - Salary/pay scale information",
            "❌ DO NOT present tabular data as paragraphs or plain lists",
            "✅ Tables make information scannable and professional",
            "",
            ...
            "      <td style=\"border: 1px solid #ddd; padding: 10px;\">Last Date to Apply</td>"
            "      <td style=\"border: 1px solid #ddd; padding: 10px;\"><strong>Jan 30, 2026</strong></td>"
            "    </tr>"
            "  </tbody>"
            "</table>",
            "",
            ...
            "",
            "ARTICLE STRUCTURE:",
            "1. Opening paragraph - Rephrase the opportunity in fresh, unique words (NOT copied from source)",
            "2. <h2>Important Dates</h2> - MUST use a table",
            "3. <h2>Vacancy Details</h2> or <h2>Post Details</h2> - MUST use a table for positions/numbers",
            "4. <h2>Eligibility Criteria</h2> - Explain in your own words clearly",
            "5. <h2>Application Fee</h2> - MUST use a table if applicable",
            "6. <h2>How to Apply</h2> - Numbered steps with embedded link",
            "7. <h2>Selection Process</h2> - If applicable, explain exam pattern/interview process",
            "",
            "TONE & READABILITY:",
            "- Explain clearly and professionally",
            "- Use short sentences with unique phrasing",
            "- One main idea per paragraph",
            "- Write factually and objectively, not an AI copying text",
            "- REWRITE all information in your own words - NO sentence should mirror the source",
            "",
            "=" * 80,
        ...
        prompt.extend([
            ...
            "=" * 80,
            "CRITICAL UNIQUENESS REMINDERS:",
            "🚫 DO NOT copy any sentence from the source material",
            "🚫 DO NOT use similar sentence structures to the original",
            "✅ COMPLETELY REPHRASE everything in your own unique way",
            "✅ Think: 'How would I explain this to a student in fresh words?'",
            "✅ MANDATORY: Use tables for all structured data (dates, fees, vacancies, etc.)",
            "✅ Add unique insights and tips after each major section to help students",
            "",
            ...
            "1. Opening paragraph with COMPLETELY REPHRASED introduction (not copied from source)",
            "2. Multiple tables for dates, vacancies, fees, etc. (MANDATORY for structured data)",
            "3. Clear, factual explanations for each section",
            "4. Embedded official links (max 3, rel=\"dofollow\" for only one link)",
            "",
            ...
            "- Use rel=\"dofollow\" attribute for ONE link only, others use rel=\"nofollow\"",
            ...
            "✅ Opening with UNIQUE rephrased introduction (NO copied sentences)",
            "✅ Multiple HTML tables for all structured data",
            "✅ Embedded official links (max 3, naturally placed)",
            "✅ Professional and factual tone",
            "✅ All HTML formatting (no markdown **bold** syntax)",
            "✅ Closing message with site bookmark reminder",
            "",
            "A clear opening paragraph that:",
            "- COMPLETELY REPHRASES the key facts in your own unique words",
            "- DO NOT use conversational phrases like 'Hey there!', 'If you're looking for', etc.",
            "- Get straight to the point with factual information in FRESH phrasing",
            "- Example approach: Instead of copying 'BCECEB announced 1445 openings', write 'Bihar's medical board is recruiting 1,445 junior doctors for government hospitals across the state'",
            "",
            "Then continue with clear, organized sections:",
            "- Use <h2> for major section headings",
            "- Use <h3> for subsections",
            "- MANDATORY: Use tables for dates, vacancies, fees - NOT paragraphs",
            "- Use <p> for paragraphs, <ul>/<ol> for lists",
            "- Embed links naturally in text flow",
            "Make it informative, unique, and scannable with tables.",
        ...
        if site_url:
            prompt.extend([
                "IMPORTANT - END YOUR ARTICLE WITH A STUDENT-FOCUSED CLOSING:",
                f"Add a final highlighted paragraph with a unique, encouraging message for students.",
                f"Mention {site_url} naturally and explain why it's helpful for job seekers.",
                "Format: <p style=\"background-color: #fff3e0; padding: 15px; border-radius: 5px; margin: 20px 0;\">",
                f"<strong>📢 Stay Updated!</strong> Bookmark {site_url} for the latest government job notifications, exam results, and admit cards. We post updates daily with detailed guides to help you succeed in your applications.",
                "</p>",
                "",
            ])
